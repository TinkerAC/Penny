package app.penny.presentation.ui.components.aayChart.barChart
...
import app.penny.presentation.ui.components.aayChart.barChart.components.BarChartContent
...
fun BarChart(
    ...
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        when (legendPosition) {
            ...
            LegendPosition.RATIO_SIDE -> throw IllegalArgumentException("Bar chart does not support RATIO_SIDE legend position")
        }
